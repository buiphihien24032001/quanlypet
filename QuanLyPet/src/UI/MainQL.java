...
public class MainQL extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pb_remove = new javax.swing.JPanel();
        jLabel38 = new javax.swing.JLabel();
        pb_add = new javax.swing.JPanel();
        jLabel35 = new javax.swing.JLabel();
        pb_statistical = new javax.swing.JPanel();
        jLabel34 = new javax.swing.JLabel();
        pb_logout = new javax.swing.JPanel();
        jLabel8 = new javax.swing.JLabel();
        pb_account = new javax.swing.JPanel();
        ...
        pb_edit = new javax.swing.JPanel();
        ...
        pb_remove.setBackground(new java.awt.Color(64, 43, 100));
        pb_remove.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pb_removemouseclick(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pb_removepb1MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                pb_removepb1MouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                pb_accountMousePressed(evt);
            }
        });
        pb_remove.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel38.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel38.setForeground(new java.awt.Color(204, 204, 204));
        jLabel38.setText("Remove");
        pb_remove.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        main_bar.add(pb_remove, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 220, 43));

        pb_add.setBackground(new java.awt.Color(64, 43, 100));
        pb_add.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pb_addmouseclick(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pb_addpb1MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                pb_addpb1MouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                pb_accountMousePressed(evt);
            }
        });
        pb_add.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel35.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel35.setForeground(new java.awt.Color(204, 204, 204));
        jLabel35.setText("Add");
        pb_add.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        main_bar.add(pb_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 300, 220, 43));
        ...
        main_bar.add(pb_statistical, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 220, 43));
        ...
        pb_account.setBackground(new java.awt.Color(64, 43, 100));
        pb_account.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                mouseclick(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
        ...
        pb_account.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(204, 204, 204));
        jLabel4.setText("Account");
        pb_account.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        main_bar.add(pb_account, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 180, 220, 43));
        ...
        main_bar.add(pb_bill, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 220, 220, 43));

        pb_edit.setBackground(new java.awt.Color(64, 43, 100));
        pb_edit.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pb_editmouseclick(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pb_editpb1MouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                pb_editpb1MouseExited(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                pb_accountMousePressed(evt);
            }
        });
        pb_edit.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        pb_edit.add(jLabel118, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 10, -1, -1));

        main_bar.add(pb_edit, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 220, 43));
    ...
    public void loaddata_bill_import() {
        try {
            ...
            Connection con = DriverManager.getConnection(url, user, pass);
            Statement st = con.createStatement();
            String sql = " SELECT hdnhaphangchitiet.mahdnhap,ngaynhap,mancc,idpet,slpet,hdnhaphangchitiet.madd,sldd,hdnhaphangchitiet.mata,slta,SUM(petnhap.gia*slpet+dodungnhap.gia*sldd+thucannhap.gia*slta) FROM dbo.hoadonnhaphang,dbo.hdnhaphangchitiet,dbo.dodungnhap,dbo.thucannhap,dbo.petnhap\n"
                    + " WHERE hdnhaphangchitiet.mahdnhap=hoadonnhaphang.mahdnhap AND mapet=idpet AND dodungnhap.madd=hdnhaphangchitiet.madd AND hdnhaphangchitiet.mata=thucannhap.mata\n"
                    + " GROUP BY hdnhaphangchitiet.mahdnhap,ngaynhap,mancc,idpet,slpet,hdnhaphangchitiet.madd,sldd,hdnhaphangchitiet.mata,slta";
            ResultSet rs = st.executeQuery(sql);
            while (rs.next()) {
                String mahd = rs.getString(1);
    ...
    public void loadchart1(){
        ...
        ds.setValue(5, "Amount of bill", "Trương Đình Hoàng");
        ds.setValue(3, "Amount of bill", "Trần Quốc Nam");
        ds.setValue(3, "Amount of bill", "Vũ Trần Đại Dương");
        ds.setValue(3, "Amount of bill", "Nguyễn Trọng Đại");
        ds.setValue(4, "Amount of bill", "Vũ Trung Tín");
        ds.setValue(2, "Amount of bill", "Nguyễn Nhật Trung");
        ds.setValue(7, "Amount of bill", "Phạm Nhật Vượng");
        ds.setValue(0, "Amount of bill", "Âu Dương Phong");
        
        JFreeChart chart1 = ChartFactory.createBarChart("","Staff name", "Amount of bill",  ds,PlotOrientation.VERTICAL,true,true,false);
    ...
    public void loadchart2(){
        DefaultCategoryDataset ds = new DefaultCategoryDataset();
        ds.setValue(61744000, "Proceeds", "Trương Đình Hoàng");
        ds.setValue(39225000, "Proceeds", "Trần Quốc Nam");
        ds.setValue(53067000, "Proceeds", "Vũ Trần Đại Dương");
        ds.setValue(33637000, "Proceeds", "Nguyễn Trọng Đại");
        ds.setValue(31069000, "Proceeds", "Vũ Trung Tín");
        ds.setValue(88925000, "Proceeds", "Nguyễn Nhật Trung");
        ds.setValue(31487000, "Proceeds", "Phạm Nhật Vượng");
        ds.setValue(0, "Proceeds", "Âu Dương Phong");
    ...
    private void pb_homeMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_homeMouseEntered
        ...
        if (evt.getSource() == pb_account) {
            pb_account.setBackground(new Color(85, 65, 118));
        }
    ...
    private void pb_homeMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_homeMouseExited
        ...
        if (evt.getSource() == pb_account) {
            pb_account.setBackground(new Color(64, 43, 100));
        }
    ...
    private void pb_addmouseclick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_addmouseclick
        // TODO add your handling code here:
        ...
        panel_remove.setVisible(false);
        panel_edit1.setVisible(false);
    }//GEN-LAST:event_pb_addmouseclick

    private void pb_addpb1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_addpb1MouseEntered
        // TODO add your handling code here:
        if (evt.getSource() == pb_add) {
            pb_add.setBackground(new Color(85, 65, 118));
        }
    }//GEN-LAST:event_pb_addpb1MouseEntered

    private void pb_addpb1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_addpb1MouseExited
        // TODO add your handling code here:
        if (evt.getSource() == pb_add) {
            pb_add.setBackground(new Color(64, 43, 100));
        }
    }//GEN-LAST:event_pb_addpb1MouseExited
    ...
    private void pb_removemouseclick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_removemouseclick
        // TODO add your handling code here:
        ...
        panel_edit1.setVisible(false);
    }//GEN-LAST:event_pb_removemouseclick

    private void pb_removepb1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_removepb1MouseEntered
        // TODO add your handling code here:
        pb_remove.setBackground(new Color(85, 65, 118));
    }//GEN-LAST:event_pb_removepb1MouseEntered

    private void pb_removepb1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_removepb1MouseExited
        // TODO add your handling code here:
        pb_remove.setBackground(new Color(64, 43, 100));
    }//GEN-LAST:event_pb_removepb1MouseExited
    ...
    private void pb_editmouseclick(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_editmouseclick
        // TODO add your handling code here:
    ...
    }//GEN-LAST:event_pb_editmouseclick

    private void pb_editpb1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_editpb1MouseEntered
        // TODO add your handling code here:
        pb_edit.setBackground(new Color(85, 65, 118));
    }//GEN-LAST:event_pb_editpb1MouseEntered

    private void pb_editpb1MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_editpb1MouseExited
        // TODO add your handling code here:
        pb_edit.setBackground(new Color(64, 43, 100));
    }//GEN-LAST:event_pb_editpb1MouseExited
    ...
    private void pb_accountMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pb_accountMousePressed
        ...
        if (evt.getSource() == pb_remove) {
            pb_remove.setBackground(new Color(85, 65, 118));
        }
        if (evt.getSource() == pb_edit) {
            pb_edit.setBackground(new Color(85, 65, 118));
        }
    ...
    private javax.swing.JPanel pb_account;
    private javax.swing.JPanel pb_add;
    private javax.swing.JPanel pb_bill;
    private javax.swing.JPanel pb_edit;
    private javax.swing.JPanel pb_logout;
    private javax.swing.JPanel pb_pay;
    private javax.swing.JPanel pb_remove;
